                        ...
                        <?php while(have_rows('image')): ?>
                            ...
                            <?php if(get_sub_field('biog')): ?>
                                <div class="team-thumb bg-white group relative md:overflow-hidden"
                                    x-data="{ memberTypes: <?php echo e($typesJson); ?> }"
                                    ...
                                    <a class="open-popup-link block relative overflow-hidden"
                                        href="#team-<?php echo e(sanitize_title(get_sub_field('name'))); ?>">
                                        <div class="overflow-hidden">
                                            <img alt="" src="<?php echo e(get_sub_field('headshot')); ?>" class="w-full h-full object-cover">
                                        </div>
                                        <div class="px-3 py-2 bg-white team-thumb-content absolute bottom-0 left-0 right-0">
                                            <div class="pl-3 border-l-2 border-dgreen leading-snug flex items-center group">
                                                ...
                                                <h3 class="font-serif text-lg leading-none mb-0 font-semibold text-black">
                                                    <?php echo e(get_sub_field('name')); ?>

                                                </h3>
                                                <p class="text-xs mb-0 text-gray-500"><?php echo e(get_sub_field('job_title')); ?></p>
                                                </div>
                    ...
                    <g id="e31aad34-8db5-48ab-b864-8f5df91c78eb" data-name="Layer 2">
                        <g id="a0316c41-9883-4677-9bcb-3b8cc0c7ca40" data-name="menu and footer">
                            ...
                            <?php else: ?>
                                ...
                                <div class="bg-white overflow-hidden relative" x-data="{ memberTypes: <?php echo e($typesJson); ?> }"
                                    x-show="activeFilter === 'all' || memberTypes.includes(activeFilter)" x-transition>
                                    <div class="relative">
                                        <div class="overflow-hidden">
                                            <img alt="" src="<?php echo e(get_sub_field('headshot')); ?>" class="w-full h-full object-cover">
...
<div class="w-full mfp-hide bg-white" id="team-<?php echo e(sanitize_title(get_sub_field('name'))); ?>">
    <div class="relative">
        ...
        <div class="flex flex-col md:flex-row">
            <div class="w-full md:w-1/2 p-8 md:p-12 ">
                <div class="border-l-4 border-dgreen pl-8 team-details">
                    <h2 class="font-serif text-3xl md:text-4xl leading-tight mb-2"><?php echo e(get_sub_field('name')); ?></h2>
                    <p class="text-gray-500 text-lg md:text-xl mb-6"><?php echo e(get_sub_field('job_title')); ?></p>
                    <div class="prose prose-lg">
                        <?php echo get_sub_field('biog'); ?>

                    </div>
                </div>
            </div>
            <div class="w-full md:w-1/2">
                <img alt="<?php echo e(get_sub_field('name')); ?>" src="<?php echo e(get_sub_field('headshot')); ?>"
