                            ...
                            <div class="w-full lg:w-9/12">
                                ...
                                <?php while( have_rows('image') ): ?> <?php (the_row()); ?>
                                    <div class="team-thumb bg-white group overflow-hidden">
                                        <a class="open-popup-link" href="#team-<?php echo e(sanitize_title(get_sub_field('name'))); ?>"><div class="overflow-hidden"><img alt="" src="<?php echo e(get_sub_field('headshot')); ?>" class="hover:scale-110 transform transition duration-200"></div>
