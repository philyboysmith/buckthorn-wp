        ...
        <div class="w-full py-12 px-6 md:p-0 lg:w-7/12">
            ...
            <div class="md:flex bg-blue text-white p-6 md:p-0">
                <div class="md:flex-grow border-l-4 border-white p-4 md:my-3 md:ml-4">
                    <div class="text-xl font-semibold mb-6"><p><?php echo e(get_sub_field('quotation')['quotation']); ?></p></div>
                    <div class="font-semibold font-serif">
                        <p class="leading-snug"><span class="text-3xl leading-none block"><?php echo e(get_sub_field('quotation')['citation']); ?></span>
                        <span class="text-base font-normal"><?php echo e(get_sub_field('quotation')['job_title']); ?></span>
                        </p>
                   </div>
                </div>

                <div class="hidden md:block flex-none ">
                    <img src="<?php echo e(get_sub_field('quotation')['image']); ?>" alt="Allan">
                </div>
            </div>
