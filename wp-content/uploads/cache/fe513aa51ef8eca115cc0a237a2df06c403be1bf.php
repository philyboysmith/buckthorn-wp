...
<main class="site-content text-grey text-lg">
    ...
    <?php if(get_field('about_title') || get_field('about_body')): ?>
        ...
        <div class="mx-auto max-w-screen-2xl p-6 mb-12">
            <div class="swiper stats-carousel">
                <div class="swiper-wrapper">
                    <?php while(have_rows('about_stats')): ?> <?php (the_row()); ?>
                    <div class="swiper-slide">
                        <div class="p-6 flex flex-col items-start stat-box"
                            style="background-color: <?php echo e(get_sub_field('colour')); ?>;">
                            <div class="border-l-4 border-white pl-4 h-full flex flex-col">
                                <?php if(get_sub_field('logo')): ?>
                                    <div class="mb-4 flex-1">
                                        <img src="<?php echo e(get_sub_field('logo')['url']); ?>" alt="<?php echo e(get_sub_field('logo')['alt']); ?>"
                                            class="h-16 w-auto object-contain">
                                    </div>
                                <?php endif; ?>
                                <div class="text-white stat-text">
                                    <?php echo get_sub_field('first_line'); ?><br /><?php echo get_sub_field('second_line'); ?>
