                            ...
                            <div class="w-full lg:w-9/12">
                                ...
                                @while ( have_rows('image') ) @php(the_row())
                                    <div class="team-thumb bg-white group">
                                        <a class="open-popup-link" href="#team-{{ sanitize_title(get_sub_field('name')) }}"><img alt="" src="{{get_sub_field('headshot')}}">
                   ...
                   <img alt="" src="{{get_sub_field('headshot')}}">
                    <div class="p-6 bg-blue text-white -mt-4 relative z-10">
                        <div class="border-l-2 pl-2">
                            ...
                            <p class="text-base mb-0 font-semibold">{{get_sub_field('job_title')}}</p>
                        </div>
                    </div>
                </div>
            </div>
