                    ...
                    <div class="lg:flex items-start">
                        <div class="w-full text-lg lg:w-full mb-12 lg:mb-0 lg:pr-24 relative">
                            ...
                            <a class="absolute inset-0 z-10" href="{{the_field('file')}}">&nbsp;</a>
                                    <h3 class="font-serif font-semibold text-2xl lg:text-3xl mb-2">{!! get_the_title() !!}</h3>
                                <div class="w-11/12">
                                    <div class="font-semibold text-sm">
                                        <p class="mb-4"><time class="inline-block updated" datetime="{{ get_post_time('c', true) }}" >{{ get_the_date() }}</time></p>
                                    </div>
