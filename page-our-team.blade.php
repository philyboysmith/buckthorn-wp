...
<div class="w-full mfp-hide bg-white" id="team-{{ sanitize_title(get_sub_field('name')) }}">
    <div class="relative">
        <div class="absolute top-0 right-14 flex pt-4 pl-4 z-20 w-20">
        ...
        <div class="absolute top-0 right-0 flex pt-4 pr-4 z-20">
...
<script>
    ...
    jQuery(document).ready(function ($) {
        ...
        $('.open-popup-link').magnificPopup({
            ...
            callbacks: {
                beforeOpen: function() {
                    // Get all visible team members (respecting current filter)
                    var visibleLinks = $('.team-thumb:visible .open-popup-link');

                    // Update the gallery items to only include visible ones
                    this.items = [];
